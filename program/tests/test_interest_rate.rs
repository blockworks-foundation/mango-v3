...
async fn test_interest_rate() {
    ...
    let base_deposit_size: f64 = 2.0;
    let base_withdraw_size: f64 = 0.05;
    ...
    let user_withdraws = vec![
        (borrower_user_index, mint_index, base_withdraw_size, true),
    ];
    ...
    let borrower_base_borrow =
        &mango_group_cookie.mango_accounts[borrower_user_index].mango_account
