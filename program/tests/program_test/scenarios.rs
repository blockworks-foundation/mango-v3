...
#[allow(dead_code)]
pub async fn withdraw_scenario_with_alternative_authority(
    test: &mut MangoProgramTest,
    mango_group_cookie: &mut MangoGroupCookie,
    ...
    let (user_index, alternative_authority_user_index, mint_index, amount, allow_borrow) = withdraw;
    let mint = test.with_mint(*mint_index);
    let withdraw_amount = (*amount * mint.unit) as u64;
    test.perform_withdraw_with_alternative_authority(
        &mango_group_cookie,
        *user_index,
...
#[allow(dead_code)]
pub async fn alternative_authority_scenario(
    test: &mut MangoProgramTest,
    mango_group_cookie: &mut MangoGroupCookie,
    user_index: usize,
    alternative_authority_user_index: usize,
) {
    test.perform_set_alternative_authority(
        &mango_group_cookie,
        user_index,
        alternative_authority_user_index,
    )
...
#[allow(dead_code)]
pub async fn reset_alternative_authority_scenario(
    test: &mut MangoProgramTest,
    mango_group_cookie: &mut MangoGroupCookie,
    user_index: usize,
    alternative_authority_user_index: usize,
) {
    test.perform_reset_alternative_authority(
        &mango_group_cookie,
        user_index,
        alternative_authority_user_index,
    )
...
#[allow(dead_code)]
pub async fn place_spot_order_scenario_with_alternative_authority(
    test: &mut MangoProgramTest,
    mango_group_cookie: &mut MangoGroupCookie,
    ...
    mango_group_cookie.users_with_spot_event[market_index].push(user_index);
    spot_market_cookie
        .place_order_with_alternative_authority(
            test,
            mango_group_cookie,
            user_index,
            alternative_authority_user_index,
